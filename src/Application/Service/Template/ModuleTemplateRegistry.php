...
final class ModuleTemplateRegistry
{
    ...
    private static function buildTwigLoader(): void
    {
        ...
        foreach (self::$modulePaths as $module => $config) {
            ...
            foreach ($aliases as $alias) {
                ...
                self::registerNamespaceOnce($loader, $alias, $config['path'], $namespaceOwners, $module);
                ...
                if (!str_starts_with($alias, 'project-layouts-')) {
                    self::registerNamespaceOnce(
                        $loader,
                        self::aliasForModule($alias),
                        $config['path'],
                        $namespaceOwners,
                        $module,
                    );
     ...
     */
    private static function registerNamespaceOnce(
